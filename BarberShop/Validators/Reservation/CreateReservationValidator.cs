...
{
    public class CreateReservationValidator : AbstractValidator<CreateReservationVm> {
        public CreateReservationValidator(IExistingEntityCheckerService checkerService) {
